...
public:
	...
	static short NumberOfDaysInMonth(short Month, short Year)
	{
		...
		short arr_31_Days[7] = { 1,3,5,7,8,10,12 };

		for (short i =1; i <= 7; i++)
		{
			if (arr_31_Days[i - 1] == Month)
				return 31;
		}
		return 30;*/
	...
	{
		string DaysNames[7] = { "Sun","Mun","Tue""Wen","Thu","Fri","Sat" };
	...
	string DayShortName()
	{
		...
		return DaysNames[DayOfWeekOrder(_Day, _Month, _Year)];
	}
